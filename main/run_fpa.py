...
The script is run:
    ...
    python3 /data/hmonttin/RNA/scripts_pub2/RNA/main/run_fpa.py identifier output_dir/ alignment_dir/ tree_dir/

    identifier: identifier linking the alignment and tree files. eg. identifier.fas and identifier.anctree
...
def main():
    ...
    The alignment file has to be in a format identifier.fasta and
    ...
    for anc_seqid, sample_seq1, sample_seq2 in go_through_branches(tree):
        ...
        for h, hit in run_fpa(anc_seq1, seq1):
            ...
            output1, _ = fpa_print(h, hit, anc_seqid,
        ...
        for h, hit in run_fpa(anc_seq2, seq2):
            ...
            output2, _ = fpa_print(h, hit, anc_seqid,
