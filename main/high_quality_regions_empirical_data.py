"""
A tool for identifying high quality (conserved) regions
in a predicted ancestral sequence.
"""
...
def main():
    ...
    data_directory: A directory, in which tree and alignment
                    files are located.
                    Tree files has to be names as
                    'clusteridentifier_xxx.anctree' and
                    alignment files as 'clusteridentifier_pagan.fas'
